...
Usage:
  python -m cli.main watcher                    # Start the file watcher
  python -m cli.main agent researcher           # Start an agent named "researcher"
  python -m cli.main status                     # Show all agent statuses
